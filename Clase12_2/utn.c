...
/**
 * \brief Verifica si el valor recibido es cuit
 * \param str Array con la cadena a ser analizada
 * \return 1 si es númerico y 0 si no lo es
 *
 */
...
int getValidStringCuit(char requestMessage[],char errorMessage[], char errorMessageLenght[],char input[], int long long maxLenght,int attemps)
{
    int i;
    int retorno=-1;
    char buffer[1024];
